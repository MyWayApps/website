        ...
        <Card className="bg-white/90 backdrop-blur-sm shadow-2xl border-0">
          <CardContent className="p-8 text-center">
            ...
            {isNumberToWord ? (
              ...
              <div className="text-5xl font-black text-gray-800 mb-8 capitalize">{question.word}</div>
            )}
            ...
            <div className="flex flex-col items-center gap-4 mb-6">
              <input
                ...
                disabled={isAnswered}
                autoFocus
                placeholder={isNumberToWord ? "e.g. forty-two" : "e.g. 42"}
                className="w-64 h-16 rounded-2xl border-4 border-green-300 text-2xl text-center font-bold text-green-900 focus:outline-none focus:border-green-500 placeholder:text-green-300 placeholder:font-normal"
              />
              <Button
