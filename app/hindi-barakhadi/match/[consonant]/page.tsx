...
import { barakhadiMatraData, barakhadiOptionText } from "@/lib/hindi-barakhadi-data"

export default function HindiMatchGame() {
  ...
  const finishGame = async (finalScore: number) => {
    ...
    const tier = await getActivityMasteryTier(
      user.id,
      applicationId,
      `barakhadi:hindi-barakhadi:match:${consonant}`,
    )
    setMasteryTier(tier)
  }
  ...
  const handleBackToMatch = () => {
    window.location.href = "/hindi-barakhadi/match"
  }
