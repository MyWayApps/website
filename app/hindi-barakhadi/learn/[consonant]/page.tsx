...
import { barakhadiMatraData, barakhadiFormula } from "@/lib/hindi-barakhadi-data"

export default function HindiLearnDetail() {
  ...
  const handleBackToLearn = () => {
    window.location.href = "/hindi-barakhadi/learn"
  }
