...
// All Telugu consonants
const teluguConsonants = [
  "క", "ఖ", "గ", "ఘ", "చ", "ఛ", "జ", "ఝ", "ట", "ఠ", "డ", "ఢ", "ణ", "త", "థ", "ద", "ధ", "న", "ప", "ఫ", "బ", "భ", "మ", "య", "ర", "ల", "వ", "శ", "ష", "స", "హ", "ళ", "క్ష"
]
...
export default function SequenceGameMain() {
  ...
  const handleStartGame = () => {
    if (selectedConsonant) {
      router.push(`/telugu-gunintaalu/sequence/${selectedConsonant}`)
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-200 to-indigo-400 p-4 flex flex-col items-center justify-center">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-indigo-700 font-semibold">
          Choose a consonant and arrange its Gunintaalu in correct order
        </p>
      </div>
