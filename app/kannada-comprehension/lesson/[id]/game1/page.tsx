...
export default function Game1Page() {
  ...
  const handleNext = async () => {
    ...
    const applicationId = `kannada-comprehension-lesson-${lessonId}-game1`
    await saveGameScore({
      userId: user.id,
      applicationId,
      score,
    ...
    const tier = await getActivityMasteryTier(user.id, applicationId, `kannada-comprehension:${lessonId}:game1`)
    setMasteryTier(tier)
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-200 to-emerald-400 p-4 relative overflow-hidden">
      ...
      <div className="text-center mb-6">
        <h1 className="text-4xl font-bold text-green-900 mb-2">
          {lesson.kannadaTitle} - Question Set 1
        </h1>
