        ...
        comprehensionLessons.map(async (lesson) => {
          const [game1Tier, game2Tier] = await Promise.all([
            getActivityMasteryTier(
              user.id,
              `tamil-comprehension-lesson-${lesson.id}-game1`,
              `tamil-comprehension:${lesson.id}:game1`,
            ),
            getActivityMasteryTier(
              user.id,
              `tamil-comprehension-lesson-${lesson.id}-game2`,
              `tamil-comprehension:${lesson.id}:game2`,
            ),
          ])
