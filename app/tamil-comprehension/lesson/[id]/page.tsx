...
export default function LessonPage() {
  ...
  const handleBackToMenu = () => {
    window.location.href = "/tamil-comprehension"
  }
  ...
  if (!lesson) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-rose-300 via-pink-400 to-fuchsia-500 flex items-center justify-center">
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-300 via-pink-400 to-fuchsia-500 p-4 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto mb-4">
        <Button
          ...
          className="bg-white/20 hover:bg-white/30 text-pink-900 border-2 border-white font-bold"
          variant="outline"
        >
      ...
      <div className="text-center mb-6">
        <h1 className="text-5xl font-bold text-pink-900 mb-2">
          {lesson.tamilTitle}
        </h1>
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <CardContent className="p-8">
            <div className="flex justify-between items-center mb-6">
              ...
              <Button
                ...
                className="bg-pink-500 hover:bg-pink-600 text-white rounded-full p-3 disabled:opacity-50"
              >
            ...
            <div className="space-y-4">
              {lesson.passage.map((line, index) => (
                <div key={index}>
                  <p className="text-2xl text-pink-900 leading-relaxed">{line}</p>
                  <p className="text-base text-pink-600/70 italic leading-relaxed">{romanize(line, "tamil")}</p>
                </div>
              ))}
            </div>
          </CardContent>
        ...
        <div className="space-y-6">
          <h2 className="text-3xl font-bold text-pink-900 text-center">
            விளையாட்டுகள் (Games)
          </h2>

          {/* Game 1 - Multiple Choice */}
          <Link href={`/tamil-comprehension/lesson/${lessonId}/game1`}>
            <Card className="bg-gradient-to-br from-green-100 to-emerald-300 hover:from-green-200 hover:to-emerald-400 cursor-pointer transition-all duration-300 hover:scale-105 shadow-lg border-4 border-white">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-xl text-green-700 mb-4">
                  தேர்ந்தெடுக்கவும் (Multiple Choice)
                </p>
          ...
          <Link href={`/tamil-comprehension/lesson/${lessonId}/game2`}>
            <Card className="bg-gradient-to-br from-purple-100 to-pink-300 hover:from-purple-200 hover:to-pink-400 cursor-pointer transition-all duration-300 hover:scale-105 shadow-lg border-4 border-white">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-xl text-purple-700 mb-4">
                  வெற்றிடங்களை நிரப்பவும் (Fill in the Blanks)
                </p>
