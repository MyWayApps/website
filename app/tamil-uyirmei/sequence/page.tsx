...
import { uyirmeiConsonants } from "@/lib/tamil-uyirmei-data"

export default function SequenceGameMain() {
  const [selectedConsonant, setSelectedConsonant] = useState("")
  const router = useRouter()

  const handleBackToUyirmei = () => {
    window.location.href = "/tamil-uyirmei"
  }

  const handleStartGame = () => {
    if (selectedConsonant) {
      router.push(`/tamil-uyirmei/sequence/${selectedConsonant}`)
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-200 to-indigo-400 p-4 flex flex-col items-center justify-center">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-indigo-700 font-semibold">
          Choose a consonant and arrange its Uyirmei in correct order
        </p>
      </div>
          ...
          <div className="text-center">
            ...
            <div className="mb-8">
              ...
              >
                ...
                {uyirmeiConsonants.map((consonant, index) => (
