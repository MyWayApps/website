...
import { gunitaksharaConsonants } from "@/lib/kannada-gunitakshara-data"

export default function KannadaSequencePickerMain() {
  const [selectedConsonant, setSelectedConsonant] = useState("")
  const router = useRouter()

  const handleBack = () => {
    window.location.href = "/kannada-gunitakshara"
  }

  const handleStartGame = () => {
    if (selectedConsonant) {
      router.push(`/kannada-gunitakshara/sequence/${selectedConsonant}`)
    }
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-200 to-indigo-400 p-4 flex flex-col items-center justify-center">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-indigo-700 font-semibold">
          Choose a consonant and arrange its Kannada letters in correct order
        </p>
      </div>
          ...
          <div className="text-center">
            ...
            <div className="mb-8">
              ...
              >
                ...
                {gunitaksharaConsonants.map((consonant, index) => (
