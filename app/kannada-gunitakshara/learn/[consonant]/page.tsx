...
import { gunitaksharaMatraData, gunitaksharaFormula } from "@/lib/kannada-gunitakshara-data"

export default function KannadaLearnDetail() {
  ...
  const updatedMatraData = gunitaksharaMatraData.map(item => ({
    ...item,
  ...
  const formulaText = gunitaksharaFormula(consonant, currentMatra.matra, currentMatra.name, currentMatra.result)
  ...
  const playAudio = async () => {
    ...
    try {
      ...
      await speakNativeAsync(`${consonant}್`)
  ...
  const handleBackToLearn = () => {
    window.location.href = "/kannada-gunitakshara/learn"
  }
