...
import { mathVideoLessons } from "@/lib/math-videos-data"
import { YouTubeEmbed } from "@/components/youtube-embed"

export default function MathVideosPage() {
  const handleBackToHome = () => {
    window.location.href = "/"
  }

  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-300 via-blue-400 to-indigo-500 p-4 flex flex-col items-center relative overflow-hidden">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-xl text-blue-900 mt-2">
          Addition &amp; subtraction, explained step by step
        </p>
      </div>

      {/* Video List */}
      <div className="w-full max-w-4xl space-y-8">
        {mathVideoLessons.map((lesson) => (
