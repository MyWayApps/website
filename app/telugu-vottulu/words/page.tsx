...
export default function WordsWithVottulu() {
  const handleBackToVottulu = () => {
    window.location.href = "/telugu-vottulu"
  }
      ...
      <Card className="w-1/2 min-w-[500px] max-w-[800px] bg-white/90 backdrop-blur-sm shadow-2xl border-0">
        <CardContent className="p-8">
          <div className="grid grid-cols-2 gap-6">
            {/* Find the word */}
            <Link href="/telugu-vottulu/words/find">
              <Card className="bg-gradient-to-br from-pink-100 to-pink-300 hover:from-pink-200 hover:to-pink-400 cursor-pointer transition-all duration-300 hover:scale-105 shadow-lg">
                <CardContent className="p-6 text-center">
                  <Search className="h-16 w-16 text-pink-700 mx-auto mb-4" />
            ...
            {/* Memory Game */}
            <Link href="/telugu-vottulu/words/memory">
              <Card className="bg-gradient-to-br from-pink-100 to-pink-300 hover:from-pink-200 hover:to-pink-400 cursor-pointer transition-all duration-300 hover:scale-105 shadow-lg">
                <CardContent className="p-6 text-center">
                  <Puzzle className="h-16 w-16 text-pink-700 mx-auto mb-4" />
                  <h3 className="text-2xl font-bold text-pink-800 mb-2">
                    Memory Game
                  </h3>
                  <p className="text-pink-600 text-lg">
                    Match words with their pairs
                  </p>
                </CardContent>
              </Card>
            </Link>
