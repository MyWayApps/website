        ...
        >
          ...
          >
            ...
            >
              ...
              <div className="text-5xl md:text-6xl font-bold break-words text-cyan-800 text-center mb-1">
                {items[index].malayalam}
              </div>
              <div className="text-lg md:text-xl text-cyan-600/80 italic text-center mb-6">
                {romanize(items[index].malayalam, "malayalam")}
              </div>
              <Button
                onClick={(e) => {
                  e.stopPropagation()
