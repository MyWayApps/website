...
import { barakhadiMatraData, barakhadiFormula } from "@/lib/sanskrit-barakhadi-data"

export default function SanskritLearnDetail() {
  ...
  const updatedMatraData = barakhadiMatraData.map(item => ({
    ...item,
  ...
  const formulaText = barakhadiFormula(consonant, currentMatra.matra, currentMatra.name, currentMatra.result)
  ...
  const playAudio = async () => {
    ...
    try {
      ...
      await speakNativeAsync(`${consonant}्`)
  ...
  const handleBackToLearn = () => {
    window.location.href = "/sanskrit-barakhadi/learn"
  }
