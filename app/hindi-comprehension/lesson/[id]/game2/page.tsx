...
export default function Game2Page() {
  ...
  const handleNext = async () => {
    ...
    const applicationId = `hindi-comprehension-lesson-${lessonId}-game2`
    await saveGameScore({
      userId: user.id,
      applicationId,
      score,
    ...
    const tier = await getActivityMasteryTier(user.id, applicationId, `hindi-comprehension:${lessonId}:game2`)
    setMasteryTier(tier)
  }
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-200 to-pink-400 p-4 relative overflow-hidden">
      ...
      <div className="text-center mb-6">
        <h1 className="text-4xl font-bold text-purple-900 mb-2">
          {lesson.hindiTitle} - Question Set 2
        </h1>
