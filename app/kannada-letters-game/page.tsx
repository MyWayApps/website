...
export default function KannadaLettersGame() {
  ...
  const handleBackToHome = () => {
    window.location.href = "/kannada-letters"
  }
  const handleRestart = () => {
    setScore(0)
    setRound(1)
  ...
  if (!isReady || letters.length === 0) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-yellow-300 via-amber-400 to-orange-500 p-4 flex flex-col items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-300 via-amber-400 to-orange-500 p-4 flex flex-col items-center justify-center relative overflow-hidden">
