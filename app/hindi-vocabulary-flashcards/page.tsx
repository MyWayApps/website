        ...
        >
          <Card
            ...
            style={{
              ...
              width: `clamp(300px, ${Math.max(items[index].hindi.length, items[index].english.length) + 4}ch, min(90vw, 700px))`,
            }}
          >
            {/* Front - Hindi */}
            <CardContent
            ...
            >
              ...
              <div className="text-5xl md:text-6xl font-bold break-words text-red-800 text-center mb-6">
                {items[index].hindi}
              </div>
              <Button
                onClick={(e) => {
